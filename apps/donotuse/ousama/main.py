...
from apps.donotuse.ousama.src.components import Client, ContraSelector, ContraAggregator
...
# create clients from clients data
clients = [Client(1, 1)]
...
client_selector = ContraSelector(clients, 40, 0.5)
aggregator = ContraAggregator(clients)
# fl parameters
